package com.coachkit.core.service.impl;

import com.coachkit.core.exception.CoreException;
import com.coachkit.core.service.JwtService;
...
public class JwtServiceImpl implements JwtService {
    ...
    @Value("${coachkit.core.jwt.secret}")
    private String jwtSecret;

    @Value("${coachkit.core.jwt.access-token-ttl}")
    ...
    public UUID validateAccessToken(String token) {
        ...
        try {
            ...
            throw new CoreException("Invalid access token", HttpStatus.UNAUTHORIZED, e);
        }
    }
    ...
    private void validateTokenType(Jwt jwt) {
        ...
        if (!"access".equals(type)) {
            throw new CoreException("Invalid token type", HttpStatus.UNAUTHORIZED);
        }
    }
}